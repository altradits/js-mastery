...
- **Ground-Up Foundation**: Starts with the absolute basics (variables, functions, parameters, return values) before advancing to operators, expressions, memory models, objects, loops, recursion, string methods, functional programming, classes, and async workflows.
- **One Concept per Lesson**: Every challenge focuses on strictly one atomic rule or syntax pattern so you can code immediately without long reading sessions.
- **Ultra-Short READMEs (~20 lines)**: 1-sentence concept, clear syntax template, quick matching code example, and 1 clear practice task.
- **Zero-Dependency Native Suite**: Built on standard ECMAScript Modules (ESM) and Node.js native testing modules (`node:test`, `node:assert/strict`).
- **Interactive Practice Runner (`runner.js`)**: Step-by-step terminal drill engine with clean error highlighting that guides you through every challenge.
- **Instant Reset Engine (`reset.js`)**: Reset all challenge files to blank comment-only starter stubs at any time.
...
|---|---|---|---|
| `01` | [01-constant-variable](challenges/01-constant-variable) | 01 — Constant Variable & Export | `01-constant-variable` |
| `02` | [02-basic-function](challenges/02-basic-function) | 02 — Basic Function & Console Output | `02-basic-function` |
| `03` | [03-function-parameter](challenges/03-function-parameter) | 03 — Function Parameter | `03-function-parameter` |
| `04` | [04-return-statement](challenges/04-return-statement) | 04 — Return Statement | `04-return-statement` |
| `05` | [05-return-parameter](challenges/05-return-parameter) | 05 — Returning a Parameter (Identity Function) | `05-return-parameter` |
| `06` | [06-primitive-string](challenges/06-primitive-string) | 06 — String Primitive | `06-primitive-string` |
| `07` | [07-primitive-number](challenges/07-primitive-number) | 07 — Number Primitive | `07-primitive-number` |
| `08` | [08-primitive-boolean](challenges/08-primitive-boolean) | 08 — Boolean Primitive | `08-primitive-boolean` |
| `09` | [09-primitive-undefined](challenges/09-primitive-undefined) | 09 — Undefined Primitive | `09-primitive-undefined` |
| `10` | [10-primitive-null](challenges/10-primitive-null) | 10 — Null Primitive | `10-primitive-null` |
| `11` | [11-escape-characters](challenges/11-escape-characters) | 11 — Escape Characters in Strings | `11-escape-characters` |
| `12` | [12-template-literals](challenges/12-template-literals) | 12 — Template Literals & Interpolation | `12-template-literals` |
| `13` | [13-string-length](challenges/13-string-length) | 13 — String Length Property | `13-string-length` |
| `14` | [14-string-char-at](challenges/14-string-char-at) | 14 — String charAt Method | `14-string-char-at` |
| `15` | [15-string-at-method](challenges/15-string-at-method) | 15 — String at Method (.at()) | `15-string-at-method` |
| `16` | [16-string-primitive-vs-object](challenges/16-string-primitive-vs-object) | 16 — String Primitives vs String Objects | `16-string-primitive-vs-object` |
| `17` | [17-string-raw](challenges/17-string-raw) | 17 — String.raw Static Method | `17-string-raw` |
| `18` | [18-string-concat](challenges/18-string-concat) | 18 — String Concatenation (+ and .concat()) | `18-string-concat` |
| `19` | [19-increment](challenges/19-increment) | 19 — Increment Function | `19-increment` |
| `20` | [20-decrement](challenges/20-decrement) | 20 — Decrement Function | `20-decrement` |
| `21` | [21-addition](challenges/21-addition) | 21 — Addition Operator (+) | `21-addition` |
| `22` | [22-subtraction](challenges/22-subtraction) | 22 — Subtraction Operator (-) | `22-subtraction` |
| `23` | [23-multiplication](challenges/23-multiplication) | 23 — Multiplication Operator (*) | `23-multiplication` |
| `24` | [24-division](challenges/24-division) | 24 — Division Operator (/) | `24-division` |
| `25` | [25-remainder](challenges/25-remainder) | 25 — Remainder / Modulo Operator (%) | `25-remainder` |
| `26` | [26-exponentiation](challenges/26-exponentiation) | 26 — Exponentiation Operator (**) | `26-exponentiation` |
| `27` | [27-unary-plus](challenges/27-unary-plus) | 27 — Unary Plus Operator (+) | `27-unary-plus` |
| `28` | [28-unary-negation](challenges/28-unary-negation) | 28 — Unary Negation Operator (-) | `28-unary-negation` |
| `29` | [29-addition-assignment](challenges/29-addition-assignment) | 29 — Addition Assignment (+=) | `29-addition-assignment` |
| `30` | [30-multiplication-assignment](challenges/30-multiplication-assignment) | 30 — Multiplication Assignment (*=) | `30-multiplication-assignment` |
| `31` | [31-logical-and-assignment](challenges/31-logical-and-assignment) | 31 — Logical AND Assignment (&&=) | `31-logical-and-assignment` |
| `32` | [32-logical-or-assignment](challenges/32-logical-or-assignment) | 32 — Logical OR Assignment (||=) | `32-logical-or-assignment` |
| `33` | [33-nullish-assignment](challenges/33-nullish-assignment) | 33 — Nullish Coalescing Assignment (??=) | `33-nullish-assignment` |
| `34` | [34-strict-equality](challenges/34-strict-equality) | 34 — Strict Equality (===) | `34-strict-equality` |
| `35` | [35-strict-inequality](challenges/35-strict-inequality) | 35 — Strict Inequality (!==) | `35-strict-inequality` |
| `36` | [36-greater-than](challenges/36-greater-than) | 36 — Greater Than Operator (>) | `36-greater-than` |
| `37` | [37-less-than](challenges/37-less-than) | 37 — Less Than Operator (<) | `37-less-than` |
| `38` | [38-greater-or-equal](challenges/38-greater-or-equal) | 38 — Greater Than or Equal (>=) | `38-greater-or-equal` |
| `39` | [39-less-or-equal](challenges/39-less-or-equal) | 39 — Less Than or Equal (<=) | `39-less-or-equal` |
| `40` | [40-in-operator](challenges/40-in-operator) | 40 — The 'in' Operator | `40-in-operator` |
| `41` | [41-instanceof-operator](challenges/41-instanceof-operator) | 41 — The 'instanceof' Operator | `41-instanceof-operator` |
| `42` | [42-logical-not](challenges/42-logical-not) | 42 — Logical NOT Operator (!) | `42-logical-not` |
| `43` | [43-double-not](challenges/43-double-not) | 43 — Double NOT (!!) for Truthiness | `43-double-not` |
| `44` | [44-logical-and](challenges/44-logical-and) | 44 — Logical AND Operator (&&) | `44-logical-and` |
| `45` | [45-logical-or](challenges/45-logical-or) | 45 — Logical OR Operator (||) | `45-logical-or` |
| `46` | [46-nullish-coalescing](challenges/46-nullish-coalescing) | 46 — Nullish Coalescing Operator (??) | `46-nullish-coalescing` |
| `47` | [47-ternary-operator](challenges/47-ternary-operator) | 47 — Conditional (Ternary) Operator (? :) | `47-ternary-operator` |
| `48` | [48-object-literal](challenges/48-object-literal) | 48 — Object Initializer Syntax | `48-object-literal` |
| `49` | [49-dynamic-get](challenges/49-dynamic-get) | 49 — Dynamic Property Lookup | `49-dynamic-get` |
| `50` | [50-dynamic-set](challenges/50-dynamic-set) | 50 — Dynamic Property Assignment | `50-dynamic-set` |
| `51` | [51-delete-operator](challenges/51-delete-operator) | 51 — The 'delete' Operator | `51-delete-operator` |
| `52` | [52-optional-chaining](challenges/52-optional-chaining) | 52 — Optional Chaining (?.) | `52-optional-chaining` |
| `53` | [53-object-reference](challenges/53-object-reference) | 53 — Object References in Memory | `53-object-reference` |
| `54` | [54-freeze-object](challenges/54-freeze-object) | 54 — Freezing an Object | `54-freeze-object` |
| `55` | [55-deep-freeze](challenges/55-deep-freeze) | 55 — Deep Object Immutability | `55-deep-freeze` |
| `56` | [56-clone-assign](challenges/56-clone-assign) | 56 — Shallow Cloning with Object.assign | `56-clone-assign` |
| `57` | [57-clone-spread](challenges/57-clone-spread) | 57 — Shallow Cloning with Spread Operator | `57-clone-spread` |
| `58` | [58-circular-reference](challenges/58-circular-reference) | 58 — Circular Object Reference | `58-circular-reference` |
| `59` | [59-array-literal](challenges/59-array-literal) | 59 — Array Initializer Syntax | `59-array-literal` |
| `60` | [60-first-element](challenges/60-first-element) | 60 — Zero-Based Indexing (First Element) | `60-first-element` |
| `61` | [61-last-element](challenges/61-last-element) | 61 — Last Element Indexing | `61-last-element` |
| `62` | [62-array-push-pop](challenges/62-array-push-pop) | 62 — Array Mutation: push & pop | `62-array-push-pop` |
| `63` | [63-array-spread](challenges/63-array-spread) | 63 — Array Spread Syntax ([...arr]) | `63-array-spread` |
| `64` | [64-freeze-array](challenges/64-freeze-array) | 64 — Freezing an Array | `64-freeze-array` |
| `65` | [65-array-destructuring](challenges/65-array-destructuring) | 65 — Array Destructuring | `65-array-destructuring` |
| `66` | [66-object-destructuring](challenges/66-object-destructuring) | 66 — Object Destructuring | `66-object-destructuring` |
| `67` | [67-while-counter](challenges/67-while-counter) | 67 — While Loop (Counter) | `67-while-counter` |
| `68` | [68-while-accumulate](challenges/68-while-accumulate) | 68 — While Loop (Accumulator) | `68-while-accumulate` |
| `69` | [69-for-loop-counter](challenges/69-for-loop-counter) | 69 — Standard For Loop | `69-for-loop-counter` |
| `70` | [70-for-of-array](challenges/70-for-of-array) | 70 — For..Of Loop (Array Iteration) | `70-for-of-array` |
| `71` | [71-for-of-string](challenges/71-for-of-string) | 71 — For..Of Loop (String Search & Counting) | `71-for-of-string` |
| `72` | [72-for-in-object](challenges/72-for-in-object) | 72 — For..In Loop (Object Keys) | `72-for-in-object` |
| `73` | [73-break-continue](challenges/73-break-continue) | 73 — Loop Control (break & continue) | `73-break-continue` |
| `74` | [74-recursion-counter](challenges/74-recursion-counter) | 74 — Recursion (Counter) | `74-recursion-counter` |
| `75` | [75-recursion-accumulate](challenges/75-recursion-accumulate) | 75 — Recursion (Accumulator) | `75-recursion-accumulate` |
| `76` | [76-recursion-factorial](challenges/76-recursion-factorial) | 76 — Recursion (Factorial) | `76-recursion-factorial` |
| `77` | [77-multiply-without-operator](challenges/77-multiply-without-operator) | 77 — Repeated Addition Multiplication | `77-multiply-without-operator` |
| `78` | [78-multiply-recursive](challenges/78-multiply-recursive) | 78 — Recursive Multiplication | `78-multiply-recursive` |
| `79` | [79-string-split](challenges/79-string-split) | 79 — Splitting Strings (.split()) | `79-string-split` |
| `80` | [80-string-join](challenges/80-string-join) | 80 — Joining Arrays into Strings (.join()) | `80-string-join` |
| `81` | [81-string-uppercase](challenges/81-string-uppercase) | 81 — Uppercase Transformation (.toUpperCase()) | `81-string-uppercase` |
| `82` | [82-string-lowercase](challenges/82-string-lowercase) | 82 — Lowercase Transformation (.toLowerCase()) | `82-string-lowercase` |
| `83` | [83-string-capitalize](challenges/83-string-capitalize) | 83 — String Capitalization | `83-string-capitalize` |
| `84` | [84-jaden-case](challenges/84-jaden-case) | 84 — Jaden Casing Strings | `84-jaden-case` |
| `85` | [85-string-cut-first](challenges/85-string-cut-first) | 85 — Cut First Characters (cutFirst) | `85-string-cut-first` |
| `86` | [86-string-cut-last](challenges/86-string-cut-last) | 86 — Cut Last Characters (cutLast) | `86-string-cut-last` |
| `87` | [87-string-cut-first-last](challenges/87-string-cut-first-last) | 87 — Cut First & Last (cutFirstLast) | `87-string-cut-first-last` |
| `88` | [88-string-keep-first](challenges/88-string-keep-first) | 88 — Keep First Characters (keepFirst) | `88-string-keep-first` |
| `89` | [89-string-keep-last](challenges/89-string-keep-last) | 89 — Keep Last Characters (keepLast) | `89-string-keep-last` |
| `90` | [90-string-repeat](challenges/90-string-repeat) | 90 — String Repeat (.repeat()) | `90-string-repeat` |
| `91` | [91-string-includes](challenges/91-string-includes) | 91 — String Inclusion Check (.includes()) | `91-string-includes` |
| `92` | [92-string-starts-with](challenges/92-string-starts-with) | 92 — Prefix Check (.startsWith()) | `92-string-starts-with` |
| `93` | [93-string-ends-with](challenges/93-string-ends-with) | 93 — Suffix Check (.endsWith()) | `93-string-ends-with` |
| `94` | [94-string-index-of](challenges/94-string-index-of) | 94 — Finding Substring Index (.indexOf()) | `94-string-index-of` |
| `95` | [95-string-last-index-of](challenges/95-string-last-index-of) | 95 — Last Substring Occurrence (.lastIndexOf()) | `95-string-last-index-of` |
| `96` | [96-string-slice](challenges/96-string-slice) | 96 — Slicing Strings (.slice()) | `96-string-slice` |
| `97` | [97-string-substring](challenges/97-string-substring) | 97 — Extracting with .substring() | `97-string-substring` |
| `98` | [98-string-trim](challenges/98-string-trim) | 98 — Trimming Whitespace (.trim()) | `98-string-trim` |
| `99` | [99-string-trim-start-end](challenges/99-string-trim-start-end) | 99 — Trimming Start & End (.trimStart & .trimEnd) | `99-string-trim-start-end` |
